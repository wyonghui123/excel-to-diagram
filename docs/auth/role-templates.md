...
### 8.1 R-CROSS-D1 — D1 域负责人

- product: [产品 P id], inherit=true
- domain: [D1 id], inherit=true (核心)
- functional perm: BO:read/create/update/delete + relationship:read/create/update/delete

### 8.2 R-CROSS-D2 — D2 域负责人 (对称 R-CROSS-D1)

- domain: [D2 id], inherit=true

### 8.3 R-CROSS-ARCH — 跨域架构师

- domain: [D1, D2, D3, D4], inherit=true (多域)
- 适用: 跨域关系设计, 不需要按编码选择模式

### 8.4 关键决策

- U1 创建 D1-D2 关系, 配 [D1] 即可 (OR-edit 语义)
- 不需要跨域架构师 (U1/U2 各自即可)
- functional perm 校验: Phase 1 软警告, Phase 2 硬拒绝
