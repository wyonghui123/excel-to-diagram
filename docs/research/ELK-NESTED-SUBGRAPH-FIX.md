...
6. [相关文件](#相关文件)
7. [重要发现](#重要发现)
8. [2024-最新发现：后处理导致容器重叠问题](#2024-最新发现：后处理导致容器重叠问题)
9. [2024-发现：Mermaid + ELK 子图 direction 限制](#2024-发现：mermaid-elk-子图-direction-限制)
10. [2024-发现：COFFMAN_GRAHAM layerBound 与"倒三角"问题](#2024-发现：coffman_graham-layerbound-与"倒三角"问题)
11. [参考](#参考)
