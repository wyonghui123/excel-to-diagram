...
1. [一、两个层面的"统一"问题](#一-两个层面的"统一"问题)
2. [二、层面 1: BO 模型层面的统一](#二-层面-1-bo-模型层面的统一)
3. [三、层面 2: Enrichment 机制层面的统一](#三-层面-2-enrichment-机制层面的统一)
4. [四、两个层面的关系](#四-两个层面的关系)
5. [五、解决方案](#五-解决方案)
6. [六、架构健康度评估](#六-架构健康度评估)
7. [七、总结与下一步行动](#七-总结与下一步行动)
8. [附录：关键代码位置](#附录：关键代码位置)
