...
1. [1. 实施路线图（8 PR / 12.5d）](#1-实施路线图（8-pr-125d）)
2. [2. PR 8 详细步骤（0.5d - 立即）](#2-pr-8-详细步骤（05d---立即）)
3. [3. PR 4 详细步骤（2d - 6 service 下沉）](#3-pr-4-详细步骤（2d---6-service-下沉）)
4. [4. PR 5 详细步骤（2d - 接口契约保护）](#4-pr-5-详细步骤（2d---接口契约保护）)
5. [5. PR 6 + PR 7 详细步骤（2d - 集成 + E2E）](#5-pr-6-pr-7-详细步骤（2d---集成-e2e）)
6. [6. PR 9 + PR 10 详细步骤（3d - Consumer 契约）](#6-pr-9-pr-10-详细步骤（3d---consumer-契约）)
7. [7. PR 11+ 详细步骤（3d - 8 大遗漏）](#7-pr-11-详细步骤（3d---8-大遗漏）)
8. [8. 风险 + 决策](#8-风险-决策)
9. [9. 实施命令清单](#9-实施命令清单)
