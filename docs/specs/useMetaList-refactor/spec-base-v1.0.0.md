...
2. [1. 背景与目标](#1-背景与目标)
3. [2. 现状深度分析](#2-现状深度分析)
4. [3. 目标架构（3 个 FR 局部）](#3-目标架构（3-个-fr-局部）)
5. [4. 详细设计 — FR-UI-003 接口契约](#4-详细设计-—-fr-ui-003-接口契约)
6. [5. 详细设计 — FR-UI-004 keyTemplateService](#5-详细设计-—-fr-ui-004-keytemplateservice)
7. [6. 详细设计 — FR-UI-005 draftPersistService](#6-详细设计-—-fr-ui-005-draftpersistservice)
8. [7. 实施计划（PR 4-7 拆分）](#7-实施计划（pr-4-7-拆分）)
9. [8. 测试策略](#8-测试策略)
10. [9. 风险与缓解](#9-风险与缓解)
11. [10. 验收总结](#10-验收总结)
12. [11. 变更 / 设计提案 (RFC)](#11-变更-设计提案-(rfc))
13. [12. 附录 — 父子 spec 关系](#12-附录-—-父子-spec-关系)
14. [13. TBD List](#13-tbd-list)
15. [14. 下一步行动](#14-下一步行动)
16. [变更记录](#变更记录)
17. [16. 真实消费侧深度审计（v1.2.0 补充）](#16-真实消费侧深度审计（v120-补充）)
18. [17. MetaListPage 组件依赖图（v1.2.0 补充）](#17-metalistpage-组件依赖图（v120-补充）)
19. [18. 与 v3 引擎衔接（v1.2.0 补充）](#18-与-v3-引擎衔接（v120-补充）)
20. [19. DetailPage ↔ MetaListPage 双向链路分析（v1.3.0 补充）](#19-detailpage-metalistpage-双向链路分析（v130-补充）)
