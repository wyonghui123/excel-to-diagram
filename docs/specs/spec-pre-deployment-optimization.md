...
1. [实施进度总览](#实施进度总览)
2. [总览](#总览)
3. [FR-1: 自动 DDL 集成](#fr-1-自动-ddl-集成)
4. [FR-2: OpenAPI 规范自动生成](#fr-2-openapi-规范自动生成)
5. [FR-3: 格式化值服务端返回](#fr-3-格式化值服务端返回)
6. [FR-4: 条件必填](#fr-4-条件必填)
7. [FR-5: server.py 与 AppBuilder 统一](#fr-5-serverpy-与-appbuilder-统一)
8. [验证总清单](#验证总清单)
9. [工作量统计](#工作量统计)
10. [与 v2 关系](#与-v2-关系)
11. [Git 历史](#git-历史)
