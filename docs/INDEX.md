...
| [staging-runbook.md](staging-runbook.md) | 138 | **staging 部署 Runbook (含 §3.4 deploy_topology)** |
...
| [INCIDENT_ALERT_SETUP.md](INCIDENT_ALERT_SETUP.md) | **告警配置 (V007.58~V007.63 飞书 App Bot 申请 + 升级摘要)** |
| [MONITORING_QUICK_REFERENCE.md](MONITORING_QUICK_REFERENCE.md) | **监控告警速查 (V007.58~V007.63 9 项 + 端点 + 命令 + 心跳)** |
| [ENCODING_INCIDENT_REPORT_20260716.md](ENCODING_INCIDENT_REPORT_20260716.md) | **编码事故复盘 2026-07-16 (V007.69 暴露 4 层防护失效, V007.70 修复路线)** |
| [PERFORMANCE_BASELINE.md](PERFORMANCE_BASELINE.md) | 性能基线 |
| [DEPLOYMENT_STANDARDS.md](DEPLOYMENT_STANDARDS.md) | **部署规范 v1.3+补遗** |
| [staging-runbook.md](staging-runbook.md) | **staging 部署 Runbook (SOP + 已知故障, 2026-09-12)** |
| [retrospectives/2026-09-13-deploy-topology-generalization.md](retrospectives/2026-09-13-deploy-topology-generalization.md) | **[2026-09-13]** 通用部署拓扑抽象 (deploy_topology + path_resolvers + deploy_upload) |
