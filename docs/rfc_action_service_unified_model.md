...
1. [0. 摘要](#0-摘要)
2. [1. 背景与动机](#1-背景与动机)
3. [2. 核心模型：3 个核心抽象](#2-核心模型：3-个核心抽象)
4. [3. 详细设计](#3-详细设计)
5. [4. 实施计划](#4-实施计划)
6. [5. 关键决策（已确认）](#5-关键决策（已确认）)
7. [6. 测试覆盖](#6-测试覆盖)
8. [7. 风险与缓解](#7-风险与缓解)
9. [8. 总结](#8-总结)
10. [9. Confirmation Request](#9-confirmation-request)
11. [10. v1 → v2 API 迁移策略（2026-06-05 补充）](#10-v1-v2-api-迁移策略（2026-06-05-补充）)
12. [11. 安全加固（与迁移策略同期落地）](#11-安全加固（与迁移策略同期落地）)
