...
- Name: annotation-metadata.spec.js >> Annotation API Tests - Annotation API 测试 >> TC-ANN-API-002: UI Config 应返回 business_object 的 annotation child_section
- Location: e2e\annotation-metadata.spec.js:64:3
