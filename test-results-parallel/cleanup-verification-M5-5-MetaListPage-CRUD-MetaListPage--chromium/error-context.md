...
- Name: cleanup-verification.spec.js >> M5   >> 5. MetaListPage  CRUD >>     MetaListPage  
- Location: e2e\cleanup-verification.spec.js:191:5
...
```ts
  96  |       const hasEnum = html.includes('') || html.includes('enums')
  97  |       const hasSystem = html.includes('') || html.includes('system')
  98  |       console.log(`business-config tab: enum=${hasEnum}, system=${hasSystem}`)
  99  |     })
  100 |   })
  101 | 
  102 |   test.describe('3.  (ArchWorkspaceNew)', () => {
  ...
  113 |       expect(html).toBeTruthy()
  114 | 
  115 |       await page.screenshot({ path: 'test-results/cleanup-homepage.png', fullPage: false })
  116 |       console.log('PASS:   ')
  117 |     })
  118 |   })
  119 | 
