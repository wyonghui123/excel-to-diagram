...
- Name: account-settings-dialog.spec.js >> 账户设置弹窗 >> 安全设置标签页应显示密码表单字段
- Location: e2e\account-settings-dialog.spec.js:166:3
...
Call log:
  - waiting for locator('.user-menu__trigger')
    - locator resolved to <div tabindex="0" role="button" id="el-id-7774-0" data-v-8289ce8d="" aria-haspopup="menu" aria-expanded="false" aria-controls="el-id-7774-1" class="user-menu__trigger el-tooltip__trigger el-tooltip__trigger">…</div>
