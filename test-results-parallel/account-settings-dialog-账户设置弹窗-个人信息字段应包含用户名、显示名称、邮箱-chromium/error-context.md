...
- Name: account-settings-dialog.spec.js >> 账户设置弹窗 >> 个人信息字段应包含用户名、显示名称、邮箱
- Location: e2e\account-settings-dialog.spec.js:269:3
...
Call log:
  - waiting for locator('.user-menu__trigger')
    - locator resolved to <div tabindex="0" role="button" id="el-id-2114-0" data-v-8289ce8d="" aria-haspopup="menu" aria-expanded="false" aria-controls="el-id-2114-1" class="user-menu__trigger el-tooltip__trigger el-tooltip__trigger">…</div>
