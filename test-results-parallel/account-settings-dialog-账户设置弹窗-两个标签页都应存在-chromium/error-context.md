...
- Name: account-settings-dialog.spec.js >> 账户设置弹窗 >> 两个标签页都应存在
- Location: e2e\account-settings-dialog.spec.js:255:3
...
Call log:
  - waiting for locator('.user-menu__trigger')
    - locator resolved to <div tabindex="0" role="button" id="el-id-3857-0" data-v-8289ce8d="" aria-haspopup="menu" aria-expanded="false" aria-controls="el-id-3857-1" class="user-menu__trigger el-tooltip__trigger el-tooltip__trigger">…</div>
