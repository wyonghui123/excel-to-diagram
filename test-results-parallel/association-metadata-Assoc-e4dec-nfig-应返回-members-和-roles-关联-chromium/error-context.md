...
- Name: association-metadata.spec.js >> Association API Integration - 关联 API 集成测试 >> TC-ASSOC-API-002: UserGroup UI Config 应返回 members 和 roles 关联
- Location: e2e\association-metadata.spec.js:464:3
