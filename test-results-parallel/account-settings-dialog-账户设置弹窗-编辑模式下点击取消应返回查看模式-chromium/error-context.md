...
- Name: account-settings-dialog.spec.js >> 账户设置弹窗 >> 编辑模式下点击取消应返回查看模式
- Location: e2e\account-settings-dialog.spec.js:122:3
...
Call log:
  - waiting for locator('.user-menu__trigger')
    - locator resolved to <div tabindex="0" role="button" id="el-id-7580-0" data-v-8289ce8d="" aria-haspopup="menu" aria-expanded="false" aria-controls="el-id-7580-1" class="user-menu__trigger el-tooltip__trigger el-tooltip__trigger">…</div>
    ...
    - generic [ref=e17]:
      ...
      - generic [ref=e21]:
        ...
        - textbox "密码" [ref=e23]:
          - /placeholder: 请输入密码
          - text: admin123
      - generic [ref=e24]: IP已被封禁，请6分钟后重试
