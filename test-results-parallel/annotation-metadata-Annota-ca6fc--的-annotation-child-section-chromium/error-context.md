...
- Name: annotation-metadata.spec.js >> Annotation API Tests - Annotation API 测试 >> TC-ANN-API-001: UI Config 应返回 service_module 的 annotation child_section
- Location: e2e\annotation-metadata.spec.js:35:3
