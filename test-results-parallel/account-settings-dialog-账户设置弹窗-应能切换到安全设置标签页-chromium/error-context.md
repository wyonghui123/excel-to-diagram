...
- Name: account-settings-dialog.spec.js >> 账户设置弹窗 >> 应能切换到安全设置标签页
- Location: e2e\account-settings-dialog.spec.js:143:3
...
Call log:
  - waiting for locator('.user-menu__trigger')
    - locator resolved to <div tabindex="0" role="button" id="el-id-815-0" data-v-8289ce8d="" aria-haspopup="menu" aria-expanded="false" aria-controls="el-id-815-1" class="user-menu__trigger el-tooltip__trigger el-tooltip__trigger">…</div>
