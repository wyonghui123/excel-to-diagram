...
# [DEPRECATED 2026-07-04] 规范规则索引

> **[!!!] 此文件已弃用 [!!!]**
>
> **请使用**: `.trae/rules/AGENT_INDEX.md` (按任务分类的统一入口)
>
> **弃用原因**:
> - 本文件按"文档类型"分类, 找到规范需要 2-3 跳
> - AGENT_INDEX.md 按"我要做什么"分类, 5 分钟定位
> - 本文件含 10+ 死链, AGENT_INDEX.md 已校验
>
> **保留原因**:
> - 兼容旧 AI Agent 引用
> - 历史追溯 (2026-06-20 v3 升级)
>
> **迁移**: 2026-07-04 dev-agent 创建 AGENT_INDEX.md 后, 本文件标记废弃
