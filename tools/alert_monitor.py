...
YONAA_PROBE = {
    ...
    # [FIX 2026-09-03] prod backend 实际端口 5001 (3011 为 2026-07 临时方案已废弃),
    # 且 .env_global 合规绑定 172.20.59.7, 必须打该 IP 而非 127.0.0.1
    'backend': ('172.20.59.7', 5001, '/api/v1/enum-types'),
    'prod_api_via_gateway': ('172.20.59.7', 8081, '/api/v1/enum-types'),
