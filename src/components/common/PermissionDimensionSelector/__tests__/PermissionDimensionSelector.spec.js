...
describe('PermissionDimensionSelector', () => {
  it('应该正确渲染组件', () => {
    ...
    expect(wrapper.find('.permission-dimension-selector').exists()).toBe(true)
    expect(wrapper.find('.permission-dimension-selector__title').text()).toBe('权限维度选择器')
  })
  ...
  it('应该显示加载状态', () => {
    ...
    expect(wrapper.find('.permission-dimension-selector__loading').exists()).toBe(true)
    expect(wrapper.find('.permission-dimension-selector__loading').text()).toContain('加载中')
  })
  ...
  it('应该显示空状态', () => {
    ...
    expect(wrapper.find('.permission-dimension-selector__empty').exists()).toBe(true)
  })
  ...
  it('应该正确映射图标', () => {
    ...
    const vm = wrapper.vm
    expect(vm.getIconName('product')).toBe('box')
    expect(vm.getIconName('version')).toBe('file')
    expect(vm.getIconName('domain')).toBe('building')
    expect(vm.getIconName('sub-domain')).toBe('folder')
    expect(vm.getIconName('unknown')).toBe('file')
  })
