...
def prerequisites() -> list:
    ...
    [2026-09-14 prod 彩排修正] 名字必须与 schema_migrations.migration_name 一致
    (带 .py 后缀)，否则 is_migration_executed 精确匹配查不到 → prereq 永远 MISSING。
    """
    return ['v072__rename_user_groups_to_orgs.py']
