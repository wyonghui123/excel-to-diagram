...
def db_for_audit():
    ...
    """)
    # 测试数据
    conn.execute("INSERT INTO permission_sets (id, name, code) VALUES (1, 'Admin', 'admin')")
    conn.execute("INSERT INTO permission_sets (id, name, code) VALUES (2, 'Auditor', 'auditor')")
    conn.execute("INSERT INTO permission_sets (id, name, code) VALUES (3, 'User', 'user')")
    conn.execute("INSERT INTO user_permission_sets (user_id, role_id) VALUES (100, 1)")
    conn.execute("INSERT INTO user_permission_sets (user_id, role_id) VALUES (200, 2)")
    conn.execute("INSERT INTO user_permission_sets (user_id, role_id) VALUES (300, 3)")
    conn.commit()
