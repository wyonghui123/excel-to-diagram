...
class TestRoleCRUD:
    ...
    def data_source(self):
        ...
        ds.execute('''CREATE TABLE IF NOT EXISTS permission_sets (
        ...
        ds.execute('''CREATE TABLE IF NOT EXISTS orgs (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            code VARCHAR(200) UNIQUE NOT NULL,
            name VARCHAR(200) NOT NULL,
            description TEXT,
        ...
        ds.execute('''CREATE TABLE IF NOT EXISTS org_members (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
        ...
        ds.execute('''CREATE TABLE IF NOT EXISTS org_permission_sets (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            group_id INTEGER NOT NULL,
    ...
    def test_create_role_basic(self, bo_framework, data_source):
        try:
            ...
            cursor = data_source.execute("SELECT * FROM permission_sets WHERE code = ?", ('TEST_ROLE',))
