...
| `/user-permission/:tab?` | 用户/角色/用户组 | [OK] |
| `/business-config/enums/:id` | 业务配置 (枚举) | [OK] |
| `/business-config/:tab?` | 业务配置 (枚举) | [OK] |
| `/system/role-permission/:roleId` | 角色管理 | [OK] |
| `/system/role-detail/:roleId` | 角色管理 | [OK] |
| `/system/archdata` | 架构数据管理 | [OK] |
...
## 七、通用组件清单 (v2 POM 选型参考)

### 表单/编辑型 (1 个)

- `MetaForm` - src\components\common\MetaForm.vue

### 过滤/搜索型 (3 个)

- `EnumSearchHelp` - src\components\common\EnumSearchHelp.vue
- `FilterVariantSelector` - src\components\common\FilterVariantSelector.vue
- `SearchHelpDialog` - src\components\common\SearchHelpDialog.vue

### 弹窗/抽屉型 (2 个)

- `ConfirmDialog` - src\components\common\ConfirmDialog.vue
- `MetaDialog` - src\components\common\MetaDialog.vue

### 选择器/枚举型 (2 个)

- `EnumSelect` - src\components\common\EnumSelect.vue
- `ValueHelpField` - src\components\common\ValueHelpField.vue

### 其他 (4 个)

- `AppHeader` - src\components\common\AppHeader.vue
- `AppRootLayout` - src\components\common\AppRootLayout.vue
- `EmptyState` - src\components\common\EmptyState.vue
- `MetaTable` - src\components\common\MetaTable.vue
